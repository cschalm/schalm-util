 ...
 * @version $Id: TableSorter.java 158 2014-03-01 22:22:07Z cschalm $
 */
public class TableSorter extends AbstractTableModel {
    private static final long serialVersionUID = -725932469601443376L;
    ...
    private final Map<Class<Object>, Comparator<Object>> columnComparators = new HashMap<>();
    ...
    public void setColumnComparator(Class<Object> type, Comparator<Object> comparator) {
        if (comparator == null) {
    ...
    public Object getValueAtInModel(int row, int column) {
        return tableModel.getValueAt(row, column);
    }

    public int getRowInView(int rowInModel) {
        return getModelToView()[rowInModel];
    }
